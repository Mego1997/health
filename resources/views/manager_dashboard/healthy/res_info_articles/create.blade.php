    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title mb-0">إضافة وصفة</h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">إضافة وصفة </li>
                        </ol>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    @if ($errors->any())
                                                ...
                                                @endif
                                    <form class="form" action="{{ route('manager_dashboard.healthy.res_info_articles.store') }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                <label>الوصفة </label>
                                                <textarea id="res-article-editor" rows="5" class="form-control border-primary" name="article_body" placeholder="المقالة"> </textarea>
                                            </div>
