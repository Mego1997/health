    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title mb-0">إضافة فيديو</h3>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    @if ($errors->any())
                                                ...
                                                @endif
                                    <form class="form" action="{{ route('manager_dashboard.healthy.videos.store') }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="userinput1" class="form-control border-primary" placeholder="عنوان الفيديو" name="vid_name">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="userinput1">رابط الفيديو</label>
                                                        <input type="text" id="userinput1" class="form-control border-primary" placeholder="رابط الفيديو" name="vid_url">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <label>الفيديو </label>
                                                <textarea id="videos-editor" rows="5" class="form-control border-primary" name="vid_description" placeholder="الفيديو"> </textarea>
                                            </div>

                                            <div class="form-group">
                                                <label>صورة الفيديو</label>
                                                <label id="projectinput7" class="file center-block">
                                                    <input type="file" id="file" name="vid_image">
