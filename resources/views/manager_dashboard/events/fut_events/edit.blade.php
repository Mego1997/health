                        ...
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form class="form" action="{{ route('manager_dashboard.events.fut_events.update', $fut_events->id) }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        @method('put')
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="userinput1" class="form-control border-primary" value="{{$fut_events->name}}" placeholder="عنوان الفعالية" name="name">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="fut_event-editor" rows="5" class="form-control border-primary"  name="body" placeholder="الفعالية"> {{$fut_events->body}}</textarea>
                                            </div>

                                            <div class="form-group col-md-6">
                                                <label>صورة الفعالية</label>
                                                <label id="projectinput7" class="file center-block">
                                                    <input type="file" id="file" value="{{$fut_events->image}}" name="image">
