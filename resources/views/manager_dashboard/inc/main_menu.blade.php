...
<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li>
                <a href="{{url('/manager/dashboard')}}"> <i class="feather icon-home"></i><span class="menu-title" data-i18n="Dashboard">الصفحة الرئيسية</span></a>
            </li>
            <li class=" nav-item"><a href=""><i class="fa-solid fa-ellipsis-vertical"></i><span class="menu-title" data-i18n="Dashboard">المكتبات</span><span class="badge badge badge-primary badge-pill float-right mr-2">3</span></a>
                <ul class="menu-content">
                    ...
                    <li>
                        ...
                        <ul class="menu-content">
                            <li><a class="menu-item" href="{{ url('/manager/dashboard/res_articles') }}" data-i18n="Analytics">الوصفات</a></li>
                            <li><a class="menu-item" href="{{ url('/manager/dashboard/res_categories') }}" data-i18n="Analytics">أنواع الوصفات</a></li>
                            <li class="active"><a class="menu-item" href="{{ url('/manager/dashboard/res_articles/create') }}" data-i18n="Analytics">إضافة وصفة</a></li>
                        </ul>
                    </li>
                    <li>
                        <a class="menu-item" href="dashboard-ecommerce.html" data-i18n="eCommerce">مكتبة الفيديو </a>
                        <ul class="menu-content">
                            <li><a class="menu-item" href="{{ url('/manager/dashboard/videos') }}" data-i18n="Analytics">الفيديوهات</a></li>
                            <li><a class="menu-item" href="{{ url('/manager/dashboard/videos_categories') }}" data-i18n="Analytics">أنواع الفيديوهات</a></li>
                            <li class="active"><a class="menu-item" href="{{ url('/manager/dashboard/videos/create') }}" data-i18n="Analytics">إضافة فيديو</a></li>
                        </ul>
                    </li>
                </ul>
            </li>
            <li class=" nav-item"><a href=""><i class="fa-solid fa-ellipsis-vertical"></i><span class="menu-title" data-i18n="Dashboard">الفعاليات</span><span class="badge badge badge-primary badge-pill float-right mr-2">3</span></a>
                <ul class="menu-content">
                    </li>
                    <li>
                        <a class="menu-item" href="dashboard-ecommerce.html" data-i18n="eCommerce">فعاليات دورية</a>
                        <ul class="menu-content">
                            <li><a class="menu-item" href="{{ url('/manager/dashboard/events') }}" data-i18n="Analytics">جميع الفعاليات</a></li>
                            <li class="active"><a class="menu-item" href="{{ url('/manager/dashboard/events/create') }}" data-i18n="Analytics">إضافة فاعلية</a></li>
                        </ul>
                    </li>
                    <li>
                        <a class="menu-item" href="dashboard-ecommerce.html" data-i18n="eCommerce">فعاليات غير دورية </a>
                        <ul class="menu-content">
                            <li><a class="menu-item" href="{{ url('/manager/dashboard/non_events') }}" data-i18n="Analytics">جميع الفعاليات</a></li>
                            <li class="active"><a class="menu-item" href="{{ url('/manager/dashboard/non_events/create') }}" data-i18n="Analytics">إضافة فاعلية</a></li>
                        </ul>
                    </li>
                    <li>
                        <a class="menu-item" href="dashboard-ecommerce.html" data-i18n="eCommerce">فعاليات مستقبلية</a>
                        <ul class="menu-content">
                            <li><a class="menu-item" href="{{ url('/manager/dashboard/fut_events') }}" data-i18n="Analytics">جميع الفعاليات</a></li>
                            <li class="active"><a class="menu-item" href="{{ url('/manager/dashboard/fut_events/create') }}" data-i18n="Analytics">إضافة فاعلية</a></li>
                        </ul>
                    </li>
                </ul>
            </li>
            <li>
                <a href="{{ url('/manager/dashboard/doctors')}}"><i class="fa-solid fa-user-doctor"></i><span class="menu-title" data-i18n="Dashboard">الأطباء</span></a>
            </li>
            ...
            <li class=" nav-item"><a href="#"><i class="feather icon-layout"></i><span class="menu-title" data-i18n="Layouts">Layouts</span></a>
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="#" data-i18n="Page Headers">Page Headers</a>
                        <ul class="menu-content">
            ...
            <li class=" nav-item"><a href="#"><i class="feather icon-zap"></i><span class="menu-title" data-i18n="Starter kit">Starter kit</span><span class="badge badge badge-danger badge-pill float-right mr-2">New</span></a>
                <ul class="menu-content">
                    <li><a class="menu-item" href="../../../starter-kit/rtl/vertical-collapsed-menu-template/layout-1-column.html" data-i18n="1 column">1 column</a>
                    </li>
                    <li><a class="menu-item" href="../../../starter-kit/rtl/vertical-collapsed-menu-template/layout-2-columns.html" data-i18n="2 columns">2 columns</a>
                    </li>
                    <li><a class="menu-item" href="#" data-i18n="Content Det Sidebar">Content Det Sidebar</a>
                        <ul class="menu-content">
                            <li><a class="menu-item" href="../../../starter-kit/rtl/vertical-collapsed-menu-template/layout-content-detached-left-sidebar.html" data-i18n="Detached left sidebar">Detached left sidebar</a>
                            </li>
                            <li><a class="menu-item" href="../../../starter-kit/rtl/vertical-collapsed-menu-template/layout-content-detached-left-sticky-sidebar.html" data-i18n="Detached sticky left sidebar">Detached sticky left sidebar</a>
                            </li>
                            <li><a class="menu-item" href="../../../starter-kit/rtl/vertical-collapsed-menu-template/layout-content-detached-right-sidebar.html" data-i18n="Detached right sidebar">Detached right sidebar</a>
                            </li>
                            <li><a class="menu-item" href="../../../starter-kit/rtl/vertical-collapsed-menu-template/layout-content-detached-right-sticky-sidebar.html" data-i18n="Detached sticky right sidebar">Detached sticky right sidebar</a>
                            </li>
                        </ul>
                    </li>
                    <li class="navigation-divider"></li>
                    <li><a class="menu-item" href="../../../starter-kit/rtl/vertical-collapsed-menu-template/layout-fixed-navbar.html" data-i18n="Fixed navbar">Fixed navbar</a>
                    </li>
                    <li><a class="menu-item" href="../../../starter-kit/rtl/vertical-collapsed-menu-template/layout-fixed-navigation.html" data-i18n="Fixed navigation">Fixed navigation</a>
                    </li>
                    <li><a class="menu-item" href="../../../starter-kit/rtl/vertical-collapsed-menu-template/layout-fixed-navbar-navigation.html" data-i18n="Fixed navbar &amp; navigation">Fixed navbar &amp; navigation</a>
                    </li>
                    <li><a class="menu-item" href="../../../starter-kit/rtl/vertical-collapsed-menu-template/layout-fixed-navbar-footer.html" data-i18n="Fixed navbar &amp; footer">Fixed navbar &amp; footer</a>
                    </li>
                    <li class="navigation-divider"></li>
                    <li><a class="menu-item" href="../../../starter-kit/rtl/vertical-collapsed-menu-template/layout-fixed.html" data-i18n="Fixed layout">Fixed layout</a>
                    </li>
                    <li><a class="menu-item" href="../../../starter-kit/rtl/vertical-collapsed-menu-template/layout-boxed.html" data-i18n="Boxed layout">Boxed layout</a>
                    </li>
                    <li><a class="menu-item" href="../../../starter-kit/rtl/vertical-collapsed-menu-template/layout-static.html" data-i18n="Static layout">Static layout</a>
                    </li>
                    <li class="navigation-divider"></li>
                    <li><a class="menu-item" href="../../../starter-kit/rtl/vertical-collapsed-menu-template/layout-light.html" data-i18n="Light layout">Light layout</a>
                    </li>
                    <li><a class="menu-item" href="../../../starter-kit/rtl/vertical-collapsed-menu-template/layout-dark.html" data-i18n="Dark layout">Dark layout</a>
                    </li>
                    <li><a class="menu-item" href="../../../starter-kit/rtl/vertical-collapsed-menu-template/layout-semi-dark.html" data-i18n="Semi dark layout">Semi dark layout</a>
                    </li>
                </ul>
            </li>
