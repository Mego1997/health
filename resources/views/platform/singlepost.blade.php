        ...
        <div class="inner-banner inner-bg3">
            <div class="container">
                <div class="inner-title text-center">
                    <h3>{{$postarticles->article_name}}</h3>
                    <ul>
                        <li>
                            <a href="/homepage">الصفحة الرئيسية</a>
                        </li>
                        <li>{{$postarticles->article_name}}</li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-8">
                        <div class="blog-details-content">
                            <div class="blog-preview-img">
                                <img src="{{ url('public/info_articles/' . $postarticles->article_image) }}" alt="Blog Images">
                            </div>
                            <ul class="tag-list">
                                <li class="active"><a href="{{ route('doctors.show', $postarticles->doc_id) }}"> <i class='bx bx-user'></i> Dr. {{$postarticles->doctor->doc_name}} </a></li>
                                <li><i class='bx bx-calendar'></i> {{$postarticles->created_at}} </li>
                                <li><i class='bx bx-comment-dots'></i> {{count($postcomments)}} تعليق </li>
                            </ul>
                            <h2>{{$postarticles->article_name}}</h2>

                            <div class="blog-article-content">
                                {!!$postarticles->article_body!!}
                            </div>
