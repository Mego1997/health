    ...
    <div class="container">
        <div class="row">
            <div class="categories-title">
                <h3>وصفات غذاء صحي <span></span></h3>
            </div>
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3">
                        <div class="blog-item" >
                            <a  href="{{ route('platform.rescategory.show', $category->id) }}">
                                <img src="{{ url('public/res_categories/' . $category->cat_image) }}" style="height:250px ; object-fit: cover ; width: 100%" class="img-fluid" alt="Blog Images">
                            </a>
                           <div class="content">
                                <span><i class="flaticon-calendar-1"></i>{{$category->created_at}}</span>
                                <h3><a href="{{ route('platform.rescategory.show', $category->id) }}"> {{$category->cat_name}}</a></h3>
                                <a href="{{ route('platform.rescategory.show', $category->id) }}" class="read-btn">قراءة المزيد</a>
                           </div>
                        </div>
                    </div>
                    @endforeach
