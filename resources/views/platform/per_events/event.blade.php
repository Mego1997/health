    ...
    <div class="inner-banner inner-bg3">
        <div class="container">
            <div class="inner-title text-center">
                <h3>{{$per_event->name}}</h3>
                <ul>
                    <li>
                        <a href="/homepage">الصفحة الرئيسية</a>
                    </li>
                    <li>{{$per_event->name}}</li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-8">
                    <div class="blog-details-content">
                        <div class="blog-preview-img">
                            <img src="{{ url('public/events/' . $per_event->image) }}" alt="Blog Images">
                        </div>
                        <ul class="tag-list">
                            <li><i class='bx bx-calendar'></i> {{$per_event->created_at}} </li>
                            <li><i class='bx bx-comment-dots'></i> {{count($postcomments)}} تعليق </li>
                        </ul>
                        <h2>{{$per_event->name}}</h2>
                                ...
                                @foreach ($recent_events as $recent  )
                                    ...
                                    <article class="item">
                                        <a href="{{ route('platform.per_events.event.show', $recent->id) }}" class="thumb">
                                            <img src="{{ url('public/events/' . $recent->image) }}"  class="full-image cover bg1" role="img">
